    ...
    public partial class Form1 : Form
    {
       ...
       /* private void btnguardar_Click(object sender, EventArgs e)
        ...
        private void Panel_resultado_Paint(object sender, PaintEventArgs e)
        {
            ...
            Panel_resultado.BackgroundImage = Codigo.Encode(BarcodeLib.TYPE.CODE128, linea, Color.Black, Color.White, 354,74);
        }
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            printFont = new Font("Courier", 16);
            Panel_resultado.DrawToBitmap(bm, new Rectangle(0, 0,591,150));
            ...
            try
            {
                ...
                while (linea != null)
                {
                    ...
                    if (a == 1)
                    {
                      e.Graphics.DrawString(linea + "\n", printFont, Brushes.Black, 186, 50);
                    }
                    if (a == 2)
                    {
                       e.Graphics.DrawString(linea + "\n", printFont, Brushes.Black, 176, 80);
                    }
                    linea = leer.ReadLine();
                }
            }
